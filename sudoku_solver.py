...
WIDTH = 550
background_color = (173, 216, 230)  # Light blue background color
        ...
        for event in pg.event.get():
            ...
            if event.type == pg.KEYDOWN:
                ...
                if(0 < event.key - 48 <10):  #checking for valid input
                    ...
                    text_x = position[0] * 50 + 50 // 2 - value.get_width() // 2
                    text_y = position[1] * 50 + 50 // 2 - value.get_height() // 2
                    win.blit(value, (text_x, text_y))
                    grid[i-1][j-1] = event.key - 48
                    pg.display.update()
                    return
                return
            ...
            if isEmpty(grid[i][j]): 
                for k in range(1, 10):
                    if isValid((i, j), k):                   
                        ...
                        # Calculate the center of the cell
                        text_x = (j + 1) * 50 + 50 // 2 - value.get_width() // 2
                        text_y = (i + 1) * 50 + 50 // 2 - value.get_height() // 2
                        win.blit(value, (text_x, text_y))
                        pg.display.update()
                        pg.time.delay(25)
    ...
    for i in range(0, len(grid[0])):
        for j in range(0, len(grid[0])):
            if(0 < grid[i][j] < 10):
                ...
                # Calculate the center of the cell
                text_x = j * 50 + 50 // 2 - value.get_width() // 2
                text_y = i * 50 + 50 // 2 - value.get_height() // 2
                win.blit(value, (text_x, text_y))
    pg.display.update()
